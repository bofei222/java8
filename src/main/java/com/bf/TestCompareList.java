...
//
////            list1.add("test" + i);
//            list1.add(new Person2(i, "bofei" + i));
//        }
//        for (int i = 0; i < 80000; i++) {
//            list2.add(new Person2(i, "bofei" + i));
////            list2.add("test" + i * 2);
//        }
//
//        List<Person2> diffrent1 = getDiffrent1(list1, list2);
//        getDiffrent2(list1, list2);
//        getDiffrent3(list1, list2);
//        List<Person2> diffrent4 = getDiffrent4(list1, list2);
//        System.out.println(diffrent4.size());
//    }
//
//    // 方法1，两层遍历查找，遍历次数为list1.size()*list2.size()，有点蠢
//    private static List<Person2> getDiffrent1(List<Person2> list1, List<Person2> list2) {
//        // diff 存放不同的元素
//        List<Person2> diff = new ArrayList<Person2>();
//        // 开始查找的时间，用于计时
//        long start = System.currentTimeMillis();
//        for (Person2 str : list1) {
...
//    private static List<Person2> getDiffrent2(List<Person2> list1, List<Person2> list2) {
//        long start = System.currentTimeMillis();
...
//    private static List<Person2> getDiffrent3(List<Person2> list1, List<Person2> list2) {
//        List<Person2> diff = new ArrayList<Person2>();
//        long start = System.currentTimeMillis();
//        Map<Person2, Integer> map = new HashMap<Person2, Integer>(list1.size() + list2.size());
//        // 将List1元素放入Map，计数1
//        for (Person2 Person : list1) {
//            map.put(Person, 1);
//        }
//        // 遍历List2，在Map中查找List2的元素，找到则计数+1；未找到则放入map，计数1
//        for (Person2 Person : list2) {
...
//            map.put(Person, 1);
//        }
//        for (Map.Entry<Person2, Integer> entry : map.entrySet()) {
//            if (entry.getValue() == 1) {
...
//
//    // 优化方法3，减少put次数
//    private static List<Person2> getDiffrent4(List<Person2> list1, List<Person2> list2) {
//        List<Person2> diff = new ArrayList<Person2>();
//        long start = System.currentTimeMillis();
//        Map<Person2, Integer> map = new HashMap<Person2, Integer>(list1.size() + list2.size());
//        List<Person2> maxList = list1;
//        List<Person2> minList = list2;
//        if (list2.size() > list1.size()) {
//            maxList = list2;
//            minList = list1;
//        }
//        for (Person2 Person : maxList) {
//            map.put(Person, 1);
//        }
//        for (Person2 Person : minList) {
//            Integer count = map.get(Person);
//            if (count != null) {
